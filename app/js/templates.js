...
this["MyApp"]["templates"]["index"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<header><div></div><div class=\"logo\"></div><div data-action=\"index\"></div></header>\n<!-- "
...
this["MyApp"]["templates"]["results"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<header><div id=\"back\"></div><div class=\"logo\"></div><div data-action=\"index\"></div></header>\n<!-- "
    + ((stack1 = this.invokePartial(partials.header,depth0,{"name":"header","data":data,"helpers":helpers,"partials":partials})) != null ? stack1 : "")
